...
{
    private readonly IBaseRepository<MedicalService> _baseRepository;

    public MedicalServiceController(IBaseRepository<MedicalService> baseRepository)
    {
    ...
    [HttpPost]
    public async Task<ActionResult> Create(MedicalService obj)
    {
    ...
    [HttpPut]
    public async Task<ActionResult> Edit(MedicalService obj)
    {
